		...
		<div class="pull-right form-inline">
			<div class="btn-group">
		    		...
		    		<!-- begin processing advisors  -->
		    				<button type="button" class="btn btn-secondary" id="all1" onclick="alladvisors()">All</button>
		    			...
		    			<%	for (int i=0;i<array.size();i++){ %>
		    					<button type="button" class="btn btn-secondary" id="button1<%=i%>" onclick="button<%=i%>()"><%=array.get(i)%></button>
