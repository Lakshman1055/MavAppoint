...
<%
response.setHeader("Refresh", 30 + "; URL = index");
%>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style=" padding-left: 20px;">
						...
						Name: <br><input type="text" name="name" id="name" value="<%= user.getName() %>"><br>
						Email address: <br><input type="text" name="email" id="email" value="<%= user.getEmail()%>"><br>
						UTA Student ID: <br><input type="text" name="studentid" value="<%= user.getId()%>"> <br>
...
<script> function FormSubmit(){
									...
									var student_phonenumber = document.getElementById("phoneNumber").value;
									var advisor_email = document.getElementById("advisor_email").value;
									var starttime = document.getElementById("starttime").value;
									var endtime = document.getElementById("endtime").value;
									var params = ('student_email='+student_email+'&phoneNumber='+student_phonenumber+'&advisor_email='+advisor_email+'&starttime='+starttime+'&endtime='+endtime);
									var xmlhttp;
