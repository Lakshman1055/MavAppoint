...
<script>
	...
	function FormSubmit() {
		...
		var params = ('uemail=' + email + '&newPassword=' + newPassword);
		var xmlhttp;
		xmlhttp = new XMLHttpRequest();
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				if (xmlhttp.responseText === "0") {
					document.getElementById("result").innerHTML = "Something went wrong while changing the password.";
				} else {
			...
			<div class="row">
				<div class="col-md-4 col-lg-4">
					<div class="form-group">
						<label for="newPassword" style="color: #ffffff;">New
							Password<span id="passwordStrength" style="color: #ffffff;"></span>
