...
CREATE TABLE `appointment_types` (
  ...
  CONSTRAINT `appointment_types_ibfk_1` FOREIGN KEY (`USERID`) REFERENCES `user` (`USERID`) ON DELETE CASCADE
...
INSERT INTO `appointment_types` VALUES (1001234567,'Add Class',5),(1001234567,'Drop Class',5),(1001234567,'Transfer Student',10);
