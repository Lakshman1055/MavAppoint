...
public class CreateAdvisorServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			ca.setPassword(EncrDecr.encrypt(request.getParameter("password")));
			ca.setId(request.getParameter("utaID"));
			ca.setRole(request.getParameter("role"));
			Visitor v = new CreateAdvisorVisitor();
			user.accept(v,ca,null);
