	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (user != null){
			try{
					...
					if (result == true){
						NotifyAppointment notify = new NotifyAppointment();
						notify.sendRemainder(request.getParameter("studentemail"), request.getParameter("date"), request.getParameter("start"), request.getParameter("end"), request.getParameter("apptype"));
